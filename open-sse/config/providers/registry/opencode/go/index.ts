...
export const opencode_goProvider: RegistryEntry = {
  ...
  models: [
    ...
    // #12674: Muse Spark 1.3 Contributor — same upstream constraint as 1.2:
    // served only on the OpenAI Responses API, not /chat/completions.
    // Effort-tier suffixes mirror the 1.2 set (minimal/low/medium/high/xhigh,
    // no max); upstream ignores unknown ids harmlessly.
    {
